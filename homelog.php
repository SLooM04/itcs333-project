...
<head>
    ...
    .welcome-paragraph {
        ...
        .recommendation-table tr:nth-child(odd) {
        ...
        .recommendation-table a.test:hover {
            background-color: #005bb5;
        }
                    /* Table Header Styling */
        body.light-mode .recommendation-table thead th {
            background-color: #0073e6;
            color: white;
        }

        body.dark-mode .recommendation-table thead th {
            background: linear-gradient(1deg, #172047, #34417d); /* Gradient */
            color: #f0f0f0;
        }
        ...
        body.light-mode .recommendation-table tbody tr {
            background-color: white;
            color: black;
        }

        body.dark-mode .recommendation-table tbody tr {
            background-color: #2e4156; /* Darker shade */
            color: #cfcfcf;
        }
        ...
        body.dark-mode .recommendation-table tbody tr:hover {
            background-color: #2e344e; /* Darker shade with subtle gradient */
        }
    ...
    <script>
        ...
        <section class="recommendations">
            ...
            <table class="recommendation-table">
                ...
                <?php if (empty($total)): ?>
                <tr>
                    <td colspan="4" style="text-align: center;">No rooms have been booked yet.</td>
                </tr>
                <?php else: ?>
                    <?php foreach ($total as $index => $room): ?>
                        <tr>
                            <td><?php echo $index + 1; ?></td>
                            <td><?php echo htmlspecialchars($room['room_name']); ?></td>
                            <td><?php echo htmlspecialchars($room['total_bookings']); ?></td>
                            <td>
                                <a href="room_details.php?id=<?php echo urlencode($room['room_id']); ?>" class="test">View Details</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
